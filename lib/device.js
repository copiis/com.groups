...
class Device extends Homey.Device {
    ...
    async initGroupListener() {
        ...
        return this.registerMultipleCapabilityListener(this.capabilities, async (values, options) => {
	        this.log('<registerMultipleCapabilityListener[' + this.getName() + ']> Called');
	        this.log('<registerMultipleCapabilityListener[' + this.getName() + ']:Values> ');
	        this.log(values);
	        this.log('</registerMultipleCapabilityListener[' + this.getName() + ']:Values> ');
    ...
    async updateDevicesCapabilities(values) {
	    ...
	    this.log('<updateDevicesCapabilities[' + this.getName() + ']> Called');
