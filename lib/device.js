...
class Device extends Homey.Device {
    ...
    async auditDevice(deviceId) {
        ...
        if (this.auditTimer) {
            ...
            this.audits[deviceId] = setTimeout(this.auditDevice.bind(this,deviceId), 5000);
    ...
    async destroyAllAudits() {
        this.log(this.getName() + ': Destroying all audits');
    ...
    async destroyAllInstances() {
        this.log(this.getName() + ': Destroying All Devices Capability Instances');
