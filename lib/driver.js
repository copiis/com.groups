...
class Driver extends Homey.Driver {
    ...
    onCapabilitiesInitialised (data, callback) {
        ...
        console.log('<driver:onCapabilitiesInitialised>');
    ...
    onCapabilitiesChanged (data, callback) {
        ...
        console.log('<driver:onCapabilitiesChanged>');
    ...
    onDevicesInitialised (data, callback) {
        ...
        console.log('<driver:onDevicesInitialised>');
    ...
    onDevicesChanged (data, callback) {
        ...
        console.log('<driver:onDevicesChanged>');
    ...
    onIconsInitialised (data, callback) {
        ...
        console.log('<driver:onIconsInitialised>');
    ...
    onIconsChanged (data, callback) {
        ...
        console.log('<driver:onIconsChanged>');
    ...
    onGroupInitialised (data, callback) {
        ...
        console.log('<driver:onGroupInitialised>');
    ...
    onGroupFinalised (data, callback) {
        ...
        console.log('<driver:onGroupFinalised>');
